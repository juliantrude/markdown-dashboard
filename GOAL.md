...
STATUS: READY
**Next action:** Increment 4 — chokidar file watch + WebSocket channel: on file change push to the client and re-render. Smoke: change the sample file → dashboard updates in < ~1s with no manual reload.
**Blockers:** none
