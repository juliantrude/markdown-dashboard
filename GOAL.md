...
STATUS: READY
**Next action:** Increment 3 — CLI entrypoint `md-dashboard <file.md>`: start a local HTTP server, read the file, serve the dashboard shell, open the browser. Smoke: run CLI against a sample `.md`, server responds with the shell.
**Blockers:** none
